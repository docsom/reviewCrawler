...
#review_loc = '{}/reviews/{}.csv'.format(cat_loc, product_id)
...
def extract_info_in_single_category(category_id):
    ...
    if os.path.isdir(std_products_loc) == False:
        print('Something is wrong. How did you make this folder?')
    ...
    if os.path.isdir(now_reviews_loc):
        ...
        for product_id in now_products:
            ...
            total_num += product_info['total_num']
            for i in range(1, 6):
